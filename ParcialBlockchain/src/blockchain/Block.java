...
public class Block implements Serializable {
    ...
    public void setTransaction(String pSender,String pArticulo,String pMarca,String pTalla, double pAmount, String pReceiver)
    {
        this.aTransactions.add(new Transaction(
        this.aTransactions.size(),pSender,pArticulo,pMarca,pTalla,pReceiver,pAmount));
    }
        
    public void setTransaction(Transaction pTran)
    {
        this.aTransactions.add(new Transaction(
        this.aTransactions.size(),pTran.getSender(),pTran.getArticulo(),pTran.getMarca(),pTran.getTalla(),pTran.getReceiver(),pTran.getAmount()));
    }
